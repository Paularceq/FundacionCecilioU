        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CartaConsentimiento = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    CartaNotas = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    CartaConsentimientoContentType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CartaNotasContentType = table.Column<string>(type: "nvarchar(max)", nullable: true),
